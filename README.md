...
* [`src/a03_alef/`](src/a03_alef/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/a03_alef/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `a03-alef` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/a03_alef/config.cljs) defaults to `true` in
...
```clj
(ns a03-alef.example
  (:require [a03-alef.config :as config])
